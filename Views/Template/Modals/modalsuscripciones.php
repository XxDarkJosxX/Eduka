<!-- Modal -->
<div class="modal fade" id="modalformsuscripciones" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Form-->
                <form autocomplete="off" class="form-horizontal" id="formsuscripciones" name="formsuscripciones" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input class="form-control" id="txtfechaini" name="txtfechaini"  type="date" required="">
                        </div>      
                        <div class="form-group col-md-4">
