        ...
        <div class="sidebar sidebar-mini sidebar-dark-pickled-bluewood sidebar-left d-flex flex-column">
            ...
            <div class="flex d-flex flex-column justify-content-start" data-perfect-scrollbar>
                <ul style="margin: auto !important;" class="nav flex-shrink-0 flex-nowrap flex-column sidebar-menu mb-0 js-sidebar-mini-tabs" role="tablist">
                    ...
                    <!-- Usuarios -->
                    <?php if (!empty($_SESSION['permisos'][2]['r']) || !empty($_SESSION['permisos'][4]['r']) || !empty($_SESSION['permisos'][5]['r'])): ?>
            ...
            <div class="sidebar sidebar-light sidebar-left flex sidebar-secondary pt-16pt" data-perfect-scrollbar>
                <div class="tab-content">
                    ...
                    <!-- Usuarios tab -->
                    <div class="tab-pane fade <?php echo (!empty($_SESSION['permisos'][2]['r']) || !empty($_SESSION['permisos'][4]['r']) || !empty($_SESSION['permisos'][5]['r'])) ? 'active show' : ''; ?>" id="sm_usuarios">
                    ...
                    <!-- Cursos tab -->
                    <div class="tab-pane fade <?php echo (!empty($_SESSION['permisos'][6]['r']) || !empty($_SESSION['permisos'][7]['r'])) ? 'active show' : ''; ?>" id="sm_cursos">
                    ...
                    <!-- Filtros tab -->
                    <div class="tab-pane fade <?php echo (!empty($_SESSION['permisos'][8]['r']) || !empty($_SESSION['permisos'][9]['r'])) ? 'active show' : ''; ?>" id="sm_filtros">
                    ...
                    <!-- Cuenta tab (siempre visible) -->
                    <div class="tab-pane fade" id="sm_cuenta">
