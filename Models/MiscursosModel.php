<?php
//Moises
class MiscursosModel extends Mysql
{
    //Nivel de accesos
    ...
    tc.titulo,
    tc.estado,
    tcat.nombre AS nombre_categoria,
    tplat.nombre AS nombre_plataforma
FROM
    tcursos tc
JOIN
...
JOIN
    tplataforma tplat ON tplat.idplataforma = tu.idplataforma
WHERE
