...
class Docentes extends Controllers
{
    ...
    public function getdocentes()
    {
        ...
        for ($i = 0; $i < count($arrdata); $i++) {
            ...
            if (!empty($_SESSION['permisosmod']['r'])) {
                $btnview = '<a class="dropdown-item btnviewdocentes" rl="' . $arrdata[$i]['idusuario'] . '">Detalles</a>';
            }

            if (!empty($_SESSION['permisosmod']['u'])) {
                $btnedit = '<a class="dropdown-item btneditdocentes" rl="' . $arrdata[$i]['idusuario'] . '">Editar</a>';
            }
