...
class Estudiantes extends Controllers
{
    ...
    public function getestudiantes()
    {
        ...
        for ($i = 0; $i < count($arrdata); $i++) {
            ...
            if (!empty($_SESSION['permisosmod']['r'])) {
                $btnview = '<a class="dropdown-item btnviewestudiantes" rl="' . $arrdata[$i]['idusuario'] . '">Detalles</a>';
            }

            if (!empty($_SESSION['permisosmod']['u'])) {
                $btnedit = '<a class="dropdown-item btneditestudiantes" rl="' . $arrdata[$i]['idusuario'] . '">Editar</a>';
            }
