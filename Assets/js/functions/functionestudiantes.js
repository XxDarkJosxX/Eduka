...
function fntdelestudiante(){
   
    $('#tableestudiantes').on('click', '.btndelestudiante', function () {
...
function fntviewcliente(){
    $('#tableestudiantes').on('click', '.btnviewestudiantes', function () {
