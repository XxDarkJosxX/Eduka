    ...
    public function getroles()
    {
        ...
        for ($i = 0; $i < count($arrdata); $i++) {
            ...
            if (!empty($_SESSION['permisosmod']['u'])) {
                $btnedit = '<a class="dropdown-item btneditroles" rl="' . $arrdata[$i]['idroles'] . '">Editar</a>';
            }

            if (!empty($_SESSION['permisosmod']['r'])) {
                $btnpermisos = '<a class="dropdown-item btnpermisorol" rl="' . $arrdata[$i]['idroles'] . '">Permisos</a>';
            }
